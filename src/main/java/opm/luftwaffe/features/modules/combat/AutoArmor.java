...
public class AutoArmor
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int) ((float) this.delay.getValue().intValue() * Luftwaffe.serverManager.getTpsFactor()))) {
            if (!this.taskList.isEmpty()) {
