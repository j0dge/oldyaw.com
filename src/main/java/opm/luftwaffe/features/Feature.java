package opm.luftwaffe.features;
...
import opm.luftwaffe.api.manager.TextManager;
...
public class Feature
    ...
    public TextManager renderer = Luftwaffe.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof LuftwaffeGui) {
            LuftwaffeGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
