...
public class CornerClip extends Module {
    ...
    public CornerClip() {
        super("CornerClip", "Draws the corner clip", Category.PLAYER, true, false, false);
    }
...
//            case Future: {
//                onMessage = ChatFormatting.RED + "[Future] " + ChatFormatting.GRAY + "CornerClip " + ChatFormatting.GREEN + "turned on" + ChatFormatting.GRAY + ".";
//                break;
//            }
//            case Luftwaffe: {
//                onMessage = "" + ChatFormatting.DARK_RED + ChatFormatting.BOLD + "luftwaffe" + ChatFormatting.GRAY + ChatFormatting.BOLD + ".xyz" +  " " + ChatFormatting.DARK_GREEN + "Successfully clipped";
//                break;
//            }
//        }
