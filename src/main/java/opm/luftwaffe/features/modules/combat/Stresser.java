...
import opm.luftwaffe.api.event.events.TotemPopEvent;
...
public class Stresser extends Module {
    ...
    public Stresser() {
        super("Stresser", "potatoaura", Category.COMBAT, true, false, false);
    }

    @SubscribeEvent
    public void onTotemPop(TotemPopEvent event) {
        if (!Luftwaffe.friendManager.isFriend(event.getEntity())) {
