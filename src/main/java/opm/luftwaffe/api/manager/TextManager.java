...
import opm.luftwaffe.features.gui.font.CustomFont;
...
public class TextManager
    ...
    public void init(boolean startup) {
        FontMod cFont = Luftwaffe.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public void drawString(String text, float x, float y, int color, boolean shadow) {
        if (Luftwaffe.moduleManager.isModuleEnabled(FontMod.getInstance().getName())) {
            if (shadow) {
