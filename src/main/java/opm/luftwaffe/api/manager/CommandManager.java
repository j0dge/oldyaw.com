...
import opm.luftwaffe.features.command.commands.*;
import opm.luftwaffe.features.command.commands.*;
...
public class CommandManager
    ...
    private String clientMessage = ChatFormatting.BOLD.toString() + ChatFormatting.DARK_RED + Luftwaffe.MODNAME1
                                 + ChatFormatting.BOLD + ChatFormatting.GRAY + Luftwaffe.MODNAME2; //idk why isnt it bold i will try to fix it later
