...
import opm.luftwaffe.api.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Luftwaffe.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : Luftwaffe.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Luftwaffe.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Luftwaffe.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
